...
func TestSQLiteStorage(t *testing.T) {
	...
	t.Run("HasQueuedItems", func(t *testing.T) {
		testHasQueuedItems(t)
	})
}

func testSaveAndRetrievePage(t *testing.T, storage *SQLiteStorage) {
...
func testSaveAndRetrieveLink(t *testing.T, storage *SQLiteStorage) {
...
func testSaveError(t *testing.T, storage *SQLiteStorage) {
...
func testQueueOperations(t *testing.T, storage *SQLiteStorage) {
	// Add items to queue
	urls := []string{
...
func testMetaOperations(t *testing.T, storage *SQLiteStorage) {
	// Set meta value
...
func testStatusBasedQueueControl(t *testing.T, storage *SQLiteStorage) {
	// Add test items
	urls := []string{
...
func testQueueResume(t *testing.T, storage *SQLiteStorage) {
...
func testQueueStatusTracking(t *testing.T) {
...
func testHasQueuedItems(t *testing.T) {
